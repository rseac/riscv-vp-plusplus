...
#include "latency_ara.h"
#include "latency_p600.h"
...
ISS_CT::ISS_CT(RV_ISA_Config *isa_config, uxlen_t hart_id)
	...
	configure_vector_latencies_p600(*this, prop_clock_cycle_period.value());
#else
	// Configure Vector Instruction Latencies (ARA approximation)
	configure_vector_latencies_ara(*this, prop_clock_cycle_period.value());
#endif
}
