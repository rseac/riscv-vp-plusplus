...
ISS_CT::ISS_CT(RV_ISA_Config *isa_config, uxlen_t hart_id)
	...
	for (int i = Operation::OpId::VSETVLI; i <= Operation::OpId::VMV_NR_R_V; ++i) {
		...
		switch (i) {
			...
			case Operation::OpId::VSOXEI64_V:
				opMap[i].instr_time = 8 * prop_clock_cycle_period.value();
				break;
			...
			case Operation::OpId::VSSEG2E64_V:
				opMap[i].instr_time = 12 * prop_clock_cycle_period.value();
				break;
			...
			case Operation::OpId::VMV_V_I:
				opMap[i].instr_time = 2 * prop_clock_cycle_period.value();
				break;
			...
			case Operation::OpId::VWSUBU_WX:
				opMap[i].instr_time = 6 * prop_clock_cycle_period.value();
				break;
			...
			case Operation::OpId::VREMU_VX:
				opMap[i].instr_time = 40 * prop_clock_cycle_period.value();
				break;
...
#else
	// Configure Vector Instruction Latencies (ARA approximation)
	...
	for (int i = Operation::OpId::VSETVLI; i <= Operation::OpId::VMV_NR_R_V; ++i) {
		...
		switch (i) {
			...
			case Operation::OpId::VLSEG2E32_V:
			case Operation::OpId::VLSEG2E64_V:
				opMap[i].instr_time = 4 * prop_clock_cycle_period.value();
				break;
			...
			case Operation::OpId::VSSEG2E32_V:
			case Operation::OpId::VSSEG2E64_V:
				opMap[i].instr_time = 3 * prop_clock_cycle_period.value();
				break;
			...
			case Operation::OpId::VREMU_VV:
			case Operation::OpId::VREMU_VX:
				opMap[i].instr_time = 32 * prop_clock_cycle_period.value();
				break;
